...
- <span id="5-tuple"></span>**[5-tuple](https://www.rfc-editor.org/rfc/rfc6146.html#section-2):** The transport protocol plus the source and destination IP addresses and port numbers. These five values identify a single network flow, and firewall rules and monitoring tools commonly match on them.
